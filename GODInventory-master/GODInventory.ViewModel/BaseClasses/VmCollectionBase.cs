...
namespace GODInventory.BaseClasses
{
    public abstract class VmCollectionBase<VM, DM> : ObservableCollection<VM>
    {
        ...
        public VmCollectionBase(  )
        {
            //InitializeDomainCollection(domainCollection);
        }

        public void InitializeDomainCollection(IList<DM> domainCollection) {
        ...
        public IList<DM> DomainCollection
        {
            get { return m_DomainCollection;  }
        }
        //public int Count
        //{
        //    get { return m_DomainCollection.Count; }
        //}
